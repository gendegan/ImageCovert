<%@ WebHandler Language="C#" Class="img20482048" %>
...
/// </summary> 
public class img20482048 : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        context.Response.ContentType = "image/jpeg";
        //获取到传递过来的img字符串,比如 
        //http://localhost:5002/img20482048.ashx?img=abacus8.jpg这种 
        ...
        if (File.Exists(path))
        {
            ...
            if (originalImage != null)
            {
                ...
                else
                {
                    ...
                    oh = originalImage.Width * 2048 / towidth;
                    x = 0;
