<%@ WebHandler Language="C#" Class="img5To4" %>
...
/// </summary> 
public class img5To4 : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        context.Response.ContentType = "image/jpeg";
        //获取到传递过来的img字符串,比如 
        //http://localhost:5002/img5To4.ashx?img=abacus8.jpg这种 
        ...
        if (File.Exists(path))
        {
            ...
            if (originalImage != null)
            {
                ...
                else
                {
                    ...
                    oh = originalImage.Width * 960 / towidth;
                    x = 0;
