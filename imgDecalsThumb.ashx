<%@ WebHandler Language="C#" Class="imgDecalsThumb" %>
...
/// </summary> 
public class imgDecalsThumb : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        context.Response.ContentType = "image/jpeg";
        //获取到传递过来的img字符串,比如 
        //http://localhost:5002/imgDecalsThumb.ashx?img=abacus8.jpg这种 
